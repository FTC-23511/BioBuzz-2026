...
public class AutomaticOffsetVelocityTuner extends OpMode {
    ...
    public void loop() {
        ...
        if (!done) {
            ...
            telemetry.addLine("xPodOffset: " + PedroConstants.localizerConfig.xPodOffset.get() + ", " + offsets.y());
            telemetry.addLine("yPodOffset: " + PedroConstants.localizerConfig.yPodOffset.get() +  ", " + offsets.x());
            telemetry.update();
        }
    }
